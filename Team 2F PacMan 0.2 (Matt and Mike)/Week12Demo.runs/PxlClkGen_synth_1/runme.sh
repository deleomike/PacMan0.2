...
HD_PWD='P:/Private/Documents/CMPEN 371/Week12Demo/Week12Demo.runs/PxlClkGen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log PxlClkGen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source PxlClkGen.tcl
