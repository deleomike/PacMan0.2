...
HD_PWD='G:/VGA/Week12Demo/Week12Demo.runs/ClkGen_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ClkGen.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ClkGen.tcl
