...
HD_PWD='E:/VGA/Final Project 371/Week12Demo.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Nexys4DdrUserDemo_optimizedAbdallah.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Nexys4DdrUserDemo_optimizedAbdallah.tcl
