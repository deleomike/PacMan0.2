...
elaborate()
{
  $xv_path/bin/xelab --relax --debug typical --mt auto -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot ClkGen xil_defaultlib.ClkGen xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  $xv_path/bin/xsim ClkGen -key {Behavioral:sim_1:Functional:ClkGen} -tclbatch cmd.tcl -log simulate.log
}
